...
export default function MessageItem({ content, sendHour, userData, type, userType, globalSelectedData, ...props }: any) {

    return type === "budget" ? <Budget content={content} userType={userType} globalSelectedData={globalSelectedData} sendHour={sendHour} userData={userData} type={type} _idPedido={props._idPedido} {...props} /> : (
