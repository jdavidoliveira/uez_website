    ...
    >
      <div className="w-full flex items-center p-5 relative">
        <div className="w-full flex flex-col items-start gap-2 relative">
          <div className="relative w-1/4 mdscreen:w-1/5 mobile:w-1/5 max-w-7xl aspect-square">
            <Image
              src={
                userData.image ||
              ...
              className="rounded-full w-full aspect-square object-cover bg-cinzero "
            />
            {/* <h1 className="text-lg font-bold text-center">{userData.name}</h1> */}
            <div className="w-6 h-6 bg-green-500 rounded-full absolute bottom-0 right-0"></div>
          </div>
        </div>
