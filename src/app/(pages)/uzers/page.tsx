...
export default function Uzers() {
    ...
    async function getUzerData() {
        try {
            const { data } = await useFetch('/uzers')
            setUzerData(data)
            return data
        } catch {
            setUzerData([{ nome: "Carregando", photoUrl: "https://via.placeholder.com/150" }])
        }
    }
                    ...
                    <form className="flex flex-col w-full items-center gap-4">
                        ...
                        <div className="flex w-full items-center justify-around gap-2">
                            <Input
                                ...
                                id="online"
                                label={"Online"}
                                handleChange={(e) => handleOnlineCheckboxChange(e.target.checked)}
                            />
                            <Input
                                type={"checkbox"}
                                id="presencial"
                        ...
                        <Input
                            ...
                            id={"cep"}
                            auxButton={<img src="/images/icons/lupa-icons8.png" />}
                            onAuxButtonClick={() => {
                                alert("teste");
                            }} />
                        <Input
