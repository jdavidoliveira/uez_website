    ...
    <main className="w-full flex flex-col items-center mx-0 bg-white" id="inicio">
      <ImageSection imageUrl="/images/p1.jpg">
        <div className="px-6 py-12 bg-azulao absolute right-0 top-1/3 rounded-l-full flex items-center justify-center">
          <h1 className="mx-8 text-white text-left text-4xl font-semibold">
            Encontre uzers <br /> que possam te ajudar!
          </h1>
        </div>
        <button className="bg-azulao py-1 px-4 rounded-full font-bold text-white absolute bottom-6 left-1/2 -translate-x-1/2 transition hover:scale-105">
          <Link href="/cadastro?userType=cliente">Torne-se um Cliente</Link>
        </button>
      ...
      <ImageSection imageUrl="/images/p2.jpg">
        <div className="px-6 py-12 bg-roxazul absolute left-0 top-1/3 rounded-r-full flex items-center justify-center">
          <h1 className="mx-8 text-white text-left text-4xl font-semibold">
            Consiga clientes, <br /> ajude mais pessoas!
          </h1>
        </div>
        <button className="bg-white py-1 px-4 rounded-full font-bold text-azulao absolute bottom-6 left-1/2 -translate-x-1/2 transition hover:scale-105">
          <Link href="/cadastro?userType=uzer">Torne-se um Uzer</Link>
        </button>
        ...
        <div className="relative flex flex-col items-center justify-around gap-16 mb-16 text-azulao w-11/12">
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce>
            <p className="text-lg leading-snug font-medium text-center mx-auto w-10/12">
              A <strong>UEZ Company</strong> é uma empresa que tem o objetivo de facilitar a sua vida, te ajudando a
              encontrar profissionais que possam realizar algum serviço para você ou se você é esse profissional e está
...
const ImageSection = ({ imageUrl, children }: { imageUrl: StaticImageData | string; children: ReactNode }) => (
  <section className={`w-full h-144 p-0 m-0 bg-gray-600 bg-center bg-cover bg-no-repeat aspect-video relative`}>
