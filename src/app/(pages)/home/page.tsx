    ...
    <main className="w-full flex flex-col items-center mx-0  bg-white" id="inicio">
      ...
      <GenericSection className="flex flex-col items-center pb-40 justify-around text-azulao ">
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <Image
              src={"/vetores/linha-baixo.svg"}
              width={120}
              height={120}
              alt="Vetor de linhas"
              className="w-6/12 pt-8 pb-4 flex z-10"
            />
            ...
            <Image
              src="/vetores/linha-cima.svg"
              width={120}
              height={120}
              alt="Vetor de linhas"
              className="w-6/12 pt-4 pb-8 flex z-10"
            />
          </div>
          <div className="flex gap-4 items-center justify-around w-full">
            <CardPhoto
      ...
      <ImageSection imageUrl="/images/p5.png">
        <div className="flex flex-col gap-2">
          <h1 className="flex z-10 mt-16 font-semibold tracking-wider text-3xl text-white self-center">
          ...
          <div className="flex z-10 justify-evenly items-center mt-36 ">
            <div
              id="frente"
              className="w-[230px]  h-[290px] rounded-2xl z-10 bg-white text-center flex flex-col items-center justify-evenly"
            >
