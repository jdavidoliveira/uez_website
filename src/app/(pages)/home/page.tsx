  ...
  return (
    <main className="w-full flex flex-col items-center mx-0" id="inicio">
      ...
      <GenericSection className="relative flex flex-col items-center justify-around gap-8 text-azulao mb-20">
        <div className="relative flex flex-col items-center justify-around gap-8 text-azulao w-11/12">
          <Image src="/images/icons/cadeado.svg" width={120} height={120} alt="Imagem ilustrativa de um cadeado" className="w-12 h-12 absolute top-8 left-0 mobile:hidden" />
        ...
        <div className="relative flex flex-col items-center justify-around gap-8 text-azulao w-11/12">
          <Image src="/images/icons/cadeado.svg" width={120} height={120} alt="Imagem ilustrativa de um cadeado" className="sm:hidden w-12 h-12 absolute top-0 left-0 smmobile:hidden" />
          <Image src="/images/icons/cadeado.svg" width={120} height={120} alt="Imagem ilustrativa de um cadeado" className="w-12 h-12 absolute top-0 right-0 smmobile:hidden" />
