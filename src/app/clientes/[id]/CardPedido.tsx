...
export default function CardPedido({
  ...
  return (
    <>
      <div
        onClick={status === "A avaliar" ? () => setShowAvaliarModal(true) : () => setShowPedidoModal(true)}
        className={twMerge(
          "bg-white cursor-pointer shadow-md rounded-xl p-6 w-10/12 m-2 transition relative group",
          status === "A avaliar" ? "animate__animated animate__headShake animate__infinite" : "hover:scale-105"
        )}
      >
        ...
        <Eye
          className={twMerge(
            "absolute top-6 right-8 hidden group-hover:block",
            status === "A avaliar" && "hidden opacity-0"
          )}
        />
      </div>
      {showAvaliarModal && (
        <div className="fixed z-50 inset-0 bg-black bg-opacity-50 flex items-center justify-center animate__animated animate__fadeIn">
          <button
            title="Fechar"
            className="absolute z-50 flex items-center justify-center bg-black md:bg-transparent rounded-xl p-1 md:top-6 md:right-8 sm:top-6 sm:right-8 top-2 right-2"
          >
          ...
          <div className="bg-white rounded-2xl md:w-9/12 p-6 pt-0 flex flex-col items-center animate__animated animate__fadeInUp animate__faster">
            ...
            <div className="w-full flex items-center flex-col lg:flex-row p-2 lg:p-10 gap-4 lg:mb-10">
              <div className="flex flex-col items-center gap-2 lg:w-1/2">
                ...
                <label htmlFor="sugestaoUzer" className="text-center sm:text-base font-bold mt-4">
                  Deixe alguma sugestão para o uzer (opcional):
                </label>
              ...
              <div className="flex flex-col items-center gap-2 lg:w-1/2">
                ...
                <label htmlFor="sugestaoPlataforma" className="text-center sm:text-base font-bold mt-4">
                  Deixe alguma sugestão para nós (opcional):
                </label>
      ...
      {showPedidoModal && (
        <div className="fixed z-50 w-full h-full top-0 left-0 flex items-center justify-center bg-black bg-opacity-50 animate__animated animate__fadeIn">
          <button
            title="Fechar"
              ...
              <div className="md:w-1/2 flex flex-col items-start gap-3">
                ...
                <div className="w-full">
                  ...
                  <textarea
                    value={descricao}
                    readOnly
                    className="w-full bg-[#EDEDED] opacity-50 p-4 text-lg font-medium rounded-2xl animate__animated animate__shakeX animate__faster"
                    cols={30}
                    rows={10}
                  ></textarea>
